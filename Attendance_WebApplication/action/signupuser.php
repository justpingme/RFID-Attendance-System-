...
if (isset($_POST['submit'])) {
  // Process the form
    ...
    $registration = mysql_prep($_POST["registration"]);
    ...
    $query .= "  name, email, password, registration, phonenumber, code, vstatus";
    $query .= ") VALUES (";
    $query .= "  '{$name}', '{$email}', '{$hashed_pwd}', '{$registration}', '{$phonenumber}', '{$code}', '0'";
    $query .= ")";
...
$mail->Body = "Please Click below clink to confirm your account <br/><br/>
<a href='http://abhinay.888webhost.com/action/activate.php?email=$email&code= $code'>click here</a>";
